<?php $this->load->view('Template/menu');?>
				...
				<div class="col-md-3">
					<div class="row" id="paddingRG">
						<div class="col-md-12 pr-0" id="kai-jumlahpengguna">
							...
							<div id="title-Xtopkai"><span>Pengguna E-Money</span></div>
						...
						<div class="col-md-12 p-0" id="boxShadoww">
							<div class="row-fluid boxPad10">
								<div class="col-md-8 pl-0 float-left">
									<span class="fontComforta mr-3 FontBold700" id="textPosVM">Vending Machine E-Money</span>
				...
				<div class="col-md-4">
					<div class="row" id="paddingRG">
						<div class="col-md-12" id="boxShadoww">
							<div class="row">
								<div class="col-md-12">
									<span class="fontComforta mr-3 FontBold700" id="textPosVM">Traffic Kondisi Mesin E-Money</span>
								</div>
			...
			<div class="row pl-3 pr-3">
					...
					<div class="row">
						<div class="col-md-12" id="boxShadoww">
							<!-- <div class="container p-0 pr-2"> -->
								<span class="fontComforta FontBold700" id="textPosVM">Traffic E-Money</span>
				...
				<div class="col-md-4">
					<div class="row pad10px">
						<div class="col-md-12" id="boxShadoww">
							<span class="fontComforta FontBold700" id="textPosVM">Top Vending Machine E-Money</span>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/emoney_graphmaps.js"></script>
