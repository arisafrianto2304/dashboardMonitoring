...
<div class="container-fluid" id="MainDashboard">
	<div class="row">
		...
		<!-- <form id="linkcombo" name="linkcombo" method="get" > -->
			<table class="table01">
				...
				<tr id="tr_periode" style="display:block;" onChange="option_Periode()"> 
				...
				<tr id="tr_periode_tanggal" style="display:block;">
				...
				<tr id="tr_periode_bulan"  style="display:none; float:right;">
					<td>Bulan</td>
					<td >&nbsp : &nbsp
					<select name="vm_periode_bulan" id="vm_periode_bulan">
					...
					<td>&nbsp Tahun ini</td>
				</tr>

				
				<tr id="tr_periode_tahun"  style="display:none; float:right;">
					<td>Tahun</td>
					<td >&nbsp : &nbsp
					<select name="vm_periodetahun" id="vm_periodetahun">
			...
			<input class="mt-2 " id="submit" type="submit" onClick="tabletampil()" value="Submit" >
		<!-- </form> -->
	...
	<div class="col-md-12" id="test-table" class="table-responsive" style="display:none;">		 
		<table id="test-tabletabled" class="table table-striped" style="width:100%">
...
<?php
	...
	$url_topup_group = file_get_contents('http://27.111.44.44/mobile/Percobaan2/get_trxmandiritp/bb');
...
// var simpan1 = (GetJSONResult('http://27.111.44.44/mobile/Percobaan2/get_trxmandiritp/bb'));
// console.log(simpan1);


// var obj;
// $.getJSON('http://27.111.44.44/mobile/Percobaan2/get_trxmandiritp/bb',obj, function(data) {
// 	console.log('test',data);
// 	obj = data;
// });
  
// fetch('http://27.111.44.44/mobile/Percobaan2/get_trxmandiritp/bb')
