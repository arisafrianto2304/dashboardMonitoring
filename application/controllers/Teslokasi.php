...
class Teslokasi extends CI_Controller {
	
	function __construct()
	{
		parent::__construct();
		$this->load->database();
		$this->load->model('M_teslokasi');
	}
	
	public function index(){
		$lokasiShow = $this->M_teslokasi->lokasiShow();
		$markerLokasi = array();
		...
		$getMarkerMapsDashboardsToday = $this->M_teslokasi->getMarkerMapsDashboardsToday();
		$markerToday = array();
		...
		$this->load->view('main/teslokasi',$data);
